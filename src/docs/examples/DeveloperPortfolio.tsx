...
function GithubIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
...
function LinkedinIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
          ...
          <section id="about" className="px-5 py-24 md:px-8">
            <div className="mx-auto max-w-7xl">
              ...
              <ComicPage layout="2-1" tone="paper">
                <ComicPanel variant="cream" shadow="lg" className="p-7 md:p-10">
                  <SpeechBubble
                    tone="pink"
                    tail="bottomLeft"
                    caption="WHO AM I?"
          ...
          >
            <div className="mx-auto max-w-7xl">
              <div className="mb-12 md:flex md:items-end md:justify-between">
                ...
                <SoundBadge variant="wham" size="lg" className="mt-7 md:mt-0" />
              </div>
                        ...
                        <div className="relative flex flex-col gap-5 pl-14 sm:flex-row sm:items-stretch sm:gap-8 sm:pl-20">
                          <div className="absolute left-0 top-5 z-10 sm:relative sm:left-auto sm:top-auto sm:w-28 sm:shrink-0 sm:pt-5">
                            <div className="flex flex-col items-center gap-3">
                              <Avatar
                                fallback={String(experience.length - index).padStart(
                                  2,
                                  "0",
                                )}
                          ...
                          >
                            ...
                            <CardContent className="px-6 pb-7 md:px-8 md:pb-9">
                              <SpeechBubble
                                ...
                                caption={
                                  index === 0 ? "ACTIVE MISSION" : "MISSION LOG"
                                }
          ...
          >
            ...
            <div className="relative mx-auto max-w-5xl text-center">
              ...
              <p className="mx-auto mt-7 max-w-2xl text-xl font-bold text-paper">
                Have a product, redesign or ambitious frontend problem? Tell me
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <FAQ type="single" variant="panel" className="mt-10">
                ...
                >
                  ...
                  <code>data/site.ts</code> so you can replace the placeholders
                  quickly.
                </FAQItem>
                <FAQItem
                  value="two"
                ...
                >
                  The project pins <strong>comixa-ui@0.1.5</strong> and uses its
                ...
                >
                  The demo validates the interaction locally. Connect the submit
                  handler to Resend, Formspree or your own API route before
                  production.
                </FAQItem>
              </FAQ>
            </div>
                ...
                <>
                  <DialogHeader>
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <Badge variant="yellow">{selectedProject.category}</Badge>
                    </div>
                  ...
                  <ComicPanel variant="sky" halftone className="mt-6 p-6">
                    ...
                    <p className="mt-3 font-bold">
                      Add the challenge, process, responsibilities, screenshots
                      and measurable result for this project.
                    </p>
                  </ComicPanel>
